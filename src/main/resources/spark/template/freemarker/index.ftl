...
<div class="text-center">
  ...
  <div class="container">
    ...
    <a type="button" class="btn btn-lg btn-primary" href="https://github.com/dhenry/game-of-thrones-api"><span class="glyphicon glyphicon-download"></span> Source on GitHub</a>
  </div>
</div>
